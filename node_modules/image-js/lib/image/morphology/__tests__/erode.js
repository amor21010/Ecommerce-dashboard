...
describe('check the erode function', function () {
  ...
  it('check for binary image 5x5', function () {
    ...
    expect(mask.erode().data).toStrictEqual(_binary.default`
        00011
        00011
        00011
        00011
  ...
  it('checks a 5x5 binary', function () {
    const mask = new _common.Image(5, 5, _binary.default`
      11111
      11011
      10001
      11011
  ...
  it('checks from binary image 5x3 with vertical kernel', function () {
    const kernel = [[1, 1, 1]];
    const mask = new _common.Image(3, 5, _binary.default`
      110
      100
      111
      001
    ...
    const expected = _binary.default`
      100
      100
      000
      001
